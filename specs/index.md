...
| [23-local-remote-command-lease-design.md](./23-local-remote-command-lease-design.md) | Session gateway design | rmux-first backend sessions, browser/API semantic operations, and Level 1 operation lease. |
